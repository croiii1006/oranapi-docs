...
export function VariationImagePage() {
  ...
  const fullPath = `${BASE_URL}/v1/images/variations`;
    ...
    <div className="flex gap-10">
      <article className="docs-content flex-1 min-w-0 max-w-[1000px]">
        ...
        <div className="flex items-start justify-between gap-4 mb-1">
          <h1 className="doc-heading-h1 !border-b-0 !pb-0 !mb-0">创建图像变体</h1>
          <CopyPageDropdown pageTitle="创建图像变体" />
        </div>
            ...
            <table className="w-full border-collapse text-sm">
              ...
              <tbody className="text-muted-foreground">
                <tr className="border-b border-border/50">
                  ...
                  <td className="py-3 px-4">用作变体基础的图像。必须是有效的 PNG 文件，小于 4MB，并且是方形的</td>
                </tr>
                <tr className="border-b border-border/50">
      ...
      "url": "https://..."
        ...
        <section id="examples" className="mt-10">
          ...
          <CodeBlock
            language="bash"
            title="cURL"
            code={`curl -X POST "${BASE_URL}/v1/images/variations" \\
...
const response = await fetch("${BASE_URL}/v1/images/variations", {
  method: "POST",
  headers: {
