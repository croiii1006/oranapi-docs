...
export function EditImagePage() {
  ...
  const fullPath = `${BASE_URL}/v1/images/edits`;
    ...
    <div className="flex gap-10">
      <article className="docs-content flex-1 min-w-0 max-w-[1000px]">
        ...
        <div className="flex items-start justify-between gap-4 mb-1">
          <h1 className="doc-heading-h1 !border-b-0 !pb-0 !mb-0">创建图片编辑</h1>
          <CopyPageDropdown pageTitle="创建图片编辑" />
        </div>
        ...
        <section id="request" className="mt-10">
          ...
          <Blockquote variant="info">
            此接口使用 <InlineCode>multipart/form-data</InlineCode> 格式提交
          </Blockquote>
            ...
            <table className="w-full border-collapse text-sm">
              ...
              <tbody className="text-muted-foreground">
                <tr className="border-b border-border/50">
                  <td className="py-3 px-4 font-medium text-foreground"><InlineCode>image</InlineCode></td>
                  <td className="py-3 px-4">file</td>
                  <td className="py-3 px-4">是</td>
                  <td className="py-3 px-4">要编辑的图像。必须是有效的 PNG 文件，小于 4MB，并且是方形的。如果未提供遮罩，图像必须具有透明度</td>
                </tr>
                <tr className="border-b border-border/50">
                ...
                <tr className="border-b border-border/50">
                  <td className="py-3 px-4 font-medium text-foreground"><InlineCode>mask</InlineCode></td>
                  <td className="py-3 px-4">file</td>
                  <td className="py-3 px-4">否</td>
                  <td className="py-3 px-4">附加图像，其完全透明区域指示应编辑的位置。必须是有效的 PNG 文件，小于 4MB</td>
                </tr>
                <tr className="border-b border-border/50">
                  <td className="py-3 px-4 font-medium text-foreground"><InlineCode>model</InlineCode></td>
                  <td className="py-3 px-4">string</td>
                  <td className="py-3 px-4">否</td>
                  <td className="py-3 px-4">用于图像编辑的模型</td>
                </tr>
                <tr className="border-b border-border/50">
                ...
                <tr className="border-b border-border/50">
                  ...
                  <td className="py-3 px-4">string</td>
                  <td className="py-3 px-4">否</td>
                  <td className="py-3 px-4">生成图像的大小。必须是 <InlineCode>256x256</InlineCode>、<InlineCode>512x512</InlineCode> 或 <InlineCode>1024x1024</InlineCode></td>
                </tr>
                <tr>
      ...
      "url": "https://..."
        ...
        <section id="examples" className="mt-10">
          ...
          <CodeBlock
            language="bash"
            title="cURL"
            code={`curl -X POST "${BASE_URL}/v1/images/edits" \\
...
formData.append('prompt', '这里的字母抹去');
